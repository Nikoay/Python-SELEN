...
def run_mark():
    ...
    # Вводим email
    driver.find_element(By.ID, 'email').send_keys('nenre@yandex.ru')
    # Вводим пароль
    driver.find_element(By.ID, 'pass').send_keys('127562')
...
class TestLocators:
    ...
    def test_show_my_pets(self):
        ...
        # driver.find_element(By.ID, 'email').send_keys('nenre@yandex.ru')
        # # Вводим пароль
        # driver.find_element(By.ID, 'pass').send_keys('12762')
        # # Нажимаем на кнопку входа в аккаунт
        # driver.find_element(By.CSS_SELECTOR, 'button[type="submit"]').click()
